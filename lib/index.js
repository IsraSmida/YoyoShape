...
function createShape(attributes) {
  ...
  var shape = {};
  yoyoShape.id = function () {
    return attributes.id;
  };
  yoyoShape.getName = function () {
    return attributes.name || '';
  };
  yoyoShape.toString = function () {
    return '( ID :' + attributes.id + ', Name : ' + attributes.name + ', nodes : ' + attributes.nodes + ')';
  };
  yoyoShape.toSvgPath = function () {
